...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
      ...
      for heceler in view.subviews {
       ...
       /*let soundURL = NSURL(fileURLWithPath: Bundle.main.path(forResource: "ding", ofType: "mp3")!)
...
//
   ...
   func clickSound(){
            var secondaudioPlayer = AVAudioPlayer()
                 ...
                 let clickSound = NSURL(fileURLWithPath: Bundle.main.path(forResource: "ding", ofType: "mp3")!)
                 do{
                         secondaudioPlayer = try AVAudioPlayer(contentsOf: clickSound as URL)
    ...
    func anotherclickSound(){
               var third = AVAudioPlayer()

                    let clickSound = NSURL(fileURLWithPath: Bundle.main.path(forResource: "win", ofType: "mp3")!)
                    do{
                            third = try AVAudioPlayer(contentsOf: clickSound as URL)
    ...
    func wrongsound(){
               var fourth = AVAudioPlayer()

                    let clickSound = NSURL(fileURLWithPath: Bundle.main.path(forResource: "wrong", ofType: "mp3")!)
                    do{
                            fourth = try AVAudioPlayer(contentsOf: clickSound as URL)
